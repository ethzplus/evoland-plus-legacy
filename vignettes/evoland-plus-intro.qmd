...
[`LULCC_CH_master.R`](https://github.com/ethzplus/evoland-with-baggage/blob/e2c7819adbcfa1446befef77e7ea5d5e0cb250c0/scripts/lulcc_ch_master.r)
...
The data should be available on Zenodo, but you could also just point the function at a local file:
...
```{r}
#' TODO Document why this was prepared. None of the produced files seem to be referenced in the current codebase.
region_prep()
```
