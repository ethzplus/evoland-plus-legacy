...
Model_lookups <- lapply(Periods, function(Period) {
  read.xlsx("Tools/Model_lookup.xlsx", sheetIndex = Period)
})
...
Trans_rates_redact <- mapply(
  function(trans_table, Unique_trans) {
