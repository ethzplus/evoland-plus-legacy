#############################################################################
## Dinamica_trans_potent_calc_testing: TESTING: Prediction of cellular transition potential
...
result <- try({
  ...
  packs <- c(
    "foreach", "data.table", "raster", "tidyverse",
...
# global env
  ...
  ### =========================================================================
  ### C- Retrieve current LULC map and layerize
  ### =========================================================================
  ...
  ### =========================================================================
  ### D- Load Suitability and Accessibility predictors
  ### =========================================================================
  ...
  cat(paste0("Loaded Suitability and Accessibility predictors from: ", loading_dir, "\n"))
  ...
  if (Use_parallel == "Y") {
    ...
    for (i in 1:nrow(Model_lookup)) {
      ...
      cat(paste0(
        " - predicting probabilities for transitions from ", Initial_LULC,
