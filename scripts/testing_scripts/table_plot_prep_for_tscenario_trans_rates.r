...
Viable_transitions_by_period <- lapply(Calibration_multistep_tables, function(x) {
  x$Initial_class <- sapply(x$From., function(y) {
    LULC_classes[LULC_classes$value == y, c("label")]
  })
  x$Final_class <- sapply(x$To., function(y) {
    LULC_classes[LULC_classes$value == y, c("label")]
  })
...
transratesextrapolation(
  trans_rate_table_path = "Data/Transition_tables/trans_rates_table_calibration_periods.csv",
  single_multi_step = "single_step"
)

transratesextrapolation(
  trans_rate_table_path = "Data/Transition_tables/trans_rates_table_calibration_periods_MS.csv",
