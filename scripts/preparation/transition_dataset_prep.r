...
Data_periods <- c("1997_2009", "2009_2018")
...
### =========================================================================
  ...
  Full_save_path <- paste0(save_dir, "/", period, "/", dataset_name, "_full_ch")
  ...
  Full_save_path <- paste0(save_dir, "/", period, "/", dataset_name, "_regionalized")
