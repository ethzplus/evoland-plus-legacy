...
### =========================================================================
### C.1- Data extraction: Full extent
### =========================================================================

if(Regionalization == FALSE){
Trans_data_full_extent <- mapply(lulcc.extractsplitrasterstack,
       Rasterstack_for_splitting = Rasterstacks_by_periods,
       Split_by = "NONE",
       Filename_data_period = names(Rasterstacks_by_periods),
       Folder_path = "Data/Transition_datasets/Full_data")}

### =========================================================================
### C.2- Data extraction: Regionalized
### =========================================================================

#Apply function to convert Rasterstacks to dataframes and then split to nested list by Bioregion and Initial LULC class
if(Regionalization == TRUE){
Trans_data_regionalized <- mapply(lulcc.extractsplitrasterstack,
       Rasterstack_for_splitting = Rasterstacks_by_periods,
       Filename_data_period = names(Rasterstacks_by_periods),
       Split_by = "Bioregion_Class_Names",
       Folder_path = "Data/Transition_datasets/Regional_data",
       SIMPLIFY = FALSE)}
...
viable_trans_lists <- readRDS("E:/LULCC_CH/Tools/Viable_transitions_lists.rds")
...
### =========================================================================
### E.1- Transition dataset creation: Full extent
### =========================================================================

if(Regionalization == FALSE){
#wrapper function for periodic trans dataset creation
lulcc.periodictransdatasetcreation <- function(Dataset_for_period,
...
Full_save_path <- paste0(folder_path, "/", filename_data_period, "_trans_datasets_full_ch") #create save path
...
### =========================================================================
### E.2- Transition dataset creation: Bioregional
### =========================================================================
...
mapply(lulcc.regionalizedperiodictransdatasetcreation,
      Regional_datasets_for_period = Trans_data_regionalized,
      filename_data_period = names(Trans_data_regionalized),
      viable_transitions_list = viable_trans_lists,
      folder_path = "Data/Transition_datasets/Pre_predictor_filtering")
}
