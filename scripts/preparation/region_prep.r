...
bioreg_6.r3 <- terra::focal(bioreg_6.r2, w = matrix(1, 3, 3), fun = "modal",
                            na.policy = "omit", fillvalue = NA)
bioreg_6.r3 <- terra::focal(bioreg_6.r3, w = matrix(1, 3, 3), fun = "modal",
                            na.policy = "omit", fillvalue = NA)
...
rat_bioregions <- data.frame(
  ...
  Class_Names  = c("Jura", "Plateau", "Northern_Prealps", "Southern_Prealps",
